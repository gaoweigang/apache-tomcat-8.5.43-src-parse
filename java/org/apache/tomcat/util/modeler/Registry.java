...
//                    localRegistry.key=key;
     ...
     *
     * @param sourceType The source type， sourceType的类型可以是MbeansDescriptorsDigesterSource，该类是使用commons Digester解析mbeans-desciptors.xml资源的类
     * @param source The bean ，source的类型可以是URL,URL类表示统一资源定位符，指向万维网上的“资源”的指针。
